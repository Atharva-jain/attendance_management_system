...
inline fun Context.locationPermissionRequest(crossinline positive: () -> Unit){
    AlertDialog.Builder(this)
        .setTitle("Location Permission Required")
        .setMessage("Without accessing the location it is not possible to Locate Your Location")
        .setPositiveButton("Allow Location") { dialogf, which ->
            positive.invoke()
        }.setNegativeButton("Cancel") { dialog, which ->
        }.show()
}
