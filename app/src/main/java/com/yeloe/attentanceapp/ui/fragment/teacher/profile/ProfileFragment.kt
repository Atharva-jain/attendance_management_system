...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        (activity as TeacherActivity).changeAppBarAccordingNavigation(Constant.TEACHER_PROFILE)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setTeacherSignInInformation((activity as TeacherActivity).mSignInDetails)
        ...
        binding.editProfileCardView.setOnClickListener {
            try {
                findNavController().navigate(R.id.action_profileFragment_to_editTeacherProfileFragment)
            } catch (e: Exception) {
        ...
        binding.logOutProfileCardView.setOnClickListener {
            logOutDialog((activity as TeacherActivity)) {
                FirebaseAuth.getInstance().signOut()
                putUserDataInSharedPreferences()
                val intent = Intent((activity as TeacherActivity), MainActivity::class.java)
                startActivity(intent)
                (activity as TeacherActivity).finish()
            }
        }
