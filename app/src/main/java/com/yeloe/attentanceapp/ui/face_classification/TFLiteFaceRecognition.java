package com.yeloe.attentanceapp.ui.face_classification;
...
public class TFLiteFaceRecognition
    ...
    private TFLiteFaceRecognition(Context ctx, HashMap<String, Recognition> faces) {
    ...
    public static FaceClassifier create(
            ...
            HashMap<String, Recognition> faces)
            throws IOException {

        final TFLiteFaceRecognition d = new TFLiteFaceRecognition(ctx, faces);
